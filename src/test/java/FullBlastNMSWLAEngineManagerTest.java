...
public class FullBlastNMSWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(FullBlastNMSWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/FullBlastNMSWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/FullBlastNMSWLAIW/InitOutcome.xml").getDocumentElement();
